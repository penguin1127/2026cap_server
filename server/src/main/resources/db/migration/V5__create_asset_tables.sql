...
CREATE TABLE asset_license_types (
    license_type_id     BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE assets (
    ...
    license_type_id BIGINT         REFERENCES asset_license_types(license_type_id),
    title           VARCHAR(100)   NOT NULL,
    description     TEXT,
    price           DECIMAL(10,2)  NOT NULL DEFAULT 0,
    is_free         BOOLEAN        NOT NULL DEFAULT TRUE,
    asset_type      VARCHAR(20)    NOT NULL DEFAULT 'SPRITE',
    -- SPRITE / TILESET / ICON / BACKGROUND / EFFECT
    thumbnail_url   VARCHAR(500),
    preview_url     VARCHAR(500),
    file_format     VARCHAR(20)    NOT NULL DEFAULT 'PNG',
    -- PNG / GIF / PSD / PIXIL / PACKAGE
    is_animated     BOOLEAN        NOT NULL DEFAULT FALSE,
    resolution      VARCHAR(50)    NOT NULL DEFAULT '32x32',
...
CREATE TABLE asset_comments (
    ...
    parent_id   BIGINT    REFERENCES asset_comments(comment_id),
